...
export default function PortfolioWizard() {
  ...
  const handleGenerate = async () => {
    ...
    const toml = generateToml({
      personalInfo: { fullName: form.fullName, fullNameAr: form.fullNameAr, title: form.title, titleAr: form.titleAr, graduationYear: form.graduationYear, university: form.university, universityAr: form.universityAr },
